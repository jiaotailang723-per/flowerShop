                    ...
                    <c:choose>
                        <c:when test="${status.first}">
                            <div class="item active">
                                <h2 class="hdng"><a href="${pageContext.request.contextPath}/flowers_detail?id=${g.id}">${g.name}</a><span></span></h2>
                                <p>今日精选推荐</p>
                                <a class="banner_a" href="javascript:;" onclick="buy(${g.id})">立刻购买</a>
                                <div class="banner-text">
                                    <a href="${pageContext.request.contextPath}/flowers_detail?id=${g.id}">
                ...
                <div class="col-md-4 gallery-grid glry-two">
                    ...
                    <div class="gallery-info galrr-info-two">
                        <p>
                            ...
                            <a href="${pageContext.request.contextPath}/flowers_detail?id=${g.id}">查看详情</a>
                        </p>
