...
<div class="products">
    <div class="container">
                        ...
                        <div class="product-img b-link-stripe b-animate-go thickbox">
                            ...
                            <div class="b-wrapper">
                                <h4 class="b-animate b-from-left b-delay03">
                                    <button href="${pageContext.request.contextPath}/flowers_detail?id=${g.id}">查看详情</button>
                                </h4>
                            </div>
                        </div>
                    </a>
        ...
        <jsp:include page="page.jsp">
            <jsp:param name="url" value="${pageContext.request.contextPath}/flowersrecommend_list"/>
