...
<div class="container-fluid">
	...
	<form class="form-horizontal" action="${pageContext.request.contextPath}/admin/goods_add" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="file" name="cover" id="input_cover" required="required">推荐尺寸: 500 * 500 | 最大10MB
			</div>
		</div>
		<div class="form-group">
			<label for="input_image1" class="col-sm-1 control-label">详情图片1</label>
			<div class="col-sm-6">
				<input type="file" name="image1" id="input_image1" required="required">推荐尺寸: 500 * 500 | 最大10MB
			</div>
		</div>
		<div class="form-group">
			<label for="input_image2" class="col-sm-1 control-label">详情图片2</label>
			<div class="col-sm-6">
				<input type="file" name="image2" id="input_image2" required="required">推荐尺寸: 500 * 500 | 最大10MB
			</div>
		</div>
		<div class="form-group">
