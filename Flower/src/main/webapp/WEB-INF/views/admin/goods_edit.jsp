...
<div class="container-fluid">
	...
	<form class="form-horizontal"
		...
		<input type="hidden" name="oldCover" value="${g.cover}"/>
		<input type="hidden" name="oldImage1" value="${g.image1}"/>
		<input type="hidden" name="oldImage2" value="${g.image2}"/>
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control" id="input_intro" name="intro" value="${g.intro}">
			</div>
		</div>
		<div class="form-group">
			<label for="input_stock" class="col-sm-1 control-label">库存</label>
			<div class="col-sm-6">
				<input type="text" class="form-control" id="input_stock" name="stock" value="${g.stock}">
			</div>
		</div>
		<div class="form-group">
			<label for="input_cover" class="col-sm-1 control-label">封面图片</label>
			<div class="col-sm-6">
				<img src="${pageContext.request.contextPath}${g.cover}" width="100" height="100"/>
				<input type="file" name="cover" id="input_cover">推荐尺寸: 500 * 500
			</div>
		</div>
		<div class="form-group">
			<label for="input_image1" class="col-sm-1 control-label">详情图片1</label>
			<div class="col-sm-6">
				<img src="${pageContext.request.contextPath}${g.image1}" width="100" height="100"/>
				<input type="file" name="image1" id="input_image1">推荐尺寸: 500 * 500
			</div>
		</div>
		<div class="form-group">
			<label for="input_image2" class="col-sm-1 control-label">详情图片2</label>
			<div class="col-sm-6">
				<img src="${pageContext.request.contextPath}${g.image2}" width="100" height="100"/>
				<input type="file" name="image2" id="input_image2">推荐尺寸: 500 * 500
			</div>
		</div>
		<div class="form-group">
