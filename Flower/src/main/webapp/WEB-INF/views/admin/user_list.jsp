...
<div class="container-fluid">
	...
	<div class="text-right"><a class="btn btn-warning" href="${pageContext.request.contextPath}/admin/user_add">添加客户</a></div>
	<c:if test="${!empty msg}">
	...
	<table class="table table-bordered table-hover">
		...
		<c:forEach items="${p.list}" var="u">
			<tr>
				...
				<td><p>${u.address}</p></td>
				<td>
					<a class="btn btn-info" href="${pageContext.request.contextPath}/admin/user_reset?id=${u.id}&username=${u.username}&userphone=${u.userphone}">重置密码</a>
